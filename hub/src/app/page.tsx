    ...
    <div className="bg-gradient-to-r from-gold/10 via-gold/5 to-gold/10 border-b border-gold/20">
      <div className="max-w-6xl mx-auto px-6 py-2 flex items-center justify-center gap-2 text-sm">
        ...
        <span className="text-text-muted">
          MJOLNIR Core is under active development. Expect breaking changes.
        </span>
        <Link
...
function HeroSection() {
  return (
    <section className="hero-gradient relative pt-44 pb-24 px-6 overflow-hidden">
      {/* Decorative grid */}
    ...
    <footer className="py-8 px-6 border-t border-border">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-sm text-text-dim">
          <Link href="https://github.com/devnull9090/mjolnir-core" target="_blank" className="hover:text-foreground transition-colors flex items-center gap-1.5">
            <GitHubIcon className="w-4 h-4" />
            GitHub
          </Link>
          <Link href="https://discord.gg/9gxYZsByW9" target="_blank" className="hover:text-foreground transition-colors flex items-center gap-1.5">
            <DiscordIcon className="w-4 h-4" />
            Discord
          </Link>
