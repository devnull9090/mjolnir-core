...
$SCAN = @{
    ...
    num0=0x52; num1=0x4F; num2=0x50; num3=0x51; num4=0x4B; num5=0x4C; num6=0x4D; num7=0x47; num8=0x48; num9=0x49
    numminus=0x4A; numplus=0x4E; numstar=0x37; numdot=0x53
}
$EXTENDED = @{
